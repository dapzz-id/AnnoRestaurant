...
import Bukti from './pages/Bukti/Bukti'
import Courir from './pages/ListCourir/Courir'
import TotalPenjualan from './pages/TotalPenjualan/totalpenjualan'
    ...
    <div>
      ...
      <div className="app-content">
        ...
        <Route path="/userlog" element={<UserLog token={token} url={url}/>}/>
          ...
          <Route path="/bukti" element={<Bukti token={token} url={url}/>}/>
          <Route path="/courir" element={<Courir token={token} url={url}/>}/>
          <Route path="/totalpenjualan" element={<TotalPenjualan token={token} url={url}/>}/>
        </Routes>
      </div>
      </>
      }
